...
const GeneralMerchandisePage = () => {
  ...
  const stats = [
    { number: '1000+', label: 'Products Available', icon: Package },
    ...
    <main className="min-h-screen">
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Comprehensive product solutions for businesses of all sizes. 
              From retail products to industrial supplies, we ensure quality, reliability, and competitive pricing.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our general merchandise service covers everything from consumer goods to industrial supplies. 
                We work with trusted manufacturers and suppliers to provide you with high-quality products 
                at competitive prices. Whether you need retail merchandise for your store or industrial 
                supplies for your operations, we have you covered.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/contact?service=general-merchandise" className="btn-primary group">
                  Get Started
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-zodiac-blue mb-6">
              Why Choose Our General Merchandise Service
            </h2>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Contact us today to discuss your general merchandise needs and discover 
              how we can help streamline your procurement process.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact?service=general-merchandise" className="btn-secondary group">
                Get a Quote
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-300" />
              </Link>
