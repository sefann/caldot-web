...
const ProcurementPage = () => {
  ...
  const stats = [
    { number: '15-25%', label: 'Cost Reduction', icon: TrendingUp },
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Strategic sourcing solutions that help optimize your supply chain, 
              reduce costs, and improve operational efficiency through expert sourcing and vendor management.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                We specialize in strategic procurement that goes beyond simple purchasing. 
                Our team analyzes your needs, identifies the best suppliers, negotiates 
                favorable terms, and manages the entire procurement process. We help you 
                build strong supplier relationships and implement cost-saving strategies.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/contact?service=procurement" className="btn-primary group">
                  Get Started
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We've helped hundreds of businesses optimize their procurement processes and reduce costs.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Contact us today to discuss your procurement needs and discover 
              how we can help reduce costs and improve efficiency.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact?service=procurement" className="btn-secondary group">
                Get a Quote
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-300" />
              </Link>
