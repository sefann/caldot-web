...
const AutomobileMaintenancePage = () => {
  ...
  const stats = [
    { number: '1000+', label: 'Vehicles Serviced', icon: Car },
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Experience hassle-free vehicle maintenance with our innovative Caldot Care subscription platform. 
              Professional service, regular maintenance, and 24/7 support.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-zodiac-blue mb-6">
                Caldot Care Platform
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Caldot Care is our revolutionary subscription-based automobile maintenance platform. 
                We provide comprehensive vehicle care including regular maintenance, emergency services, 
                and 24/7 support. Our certified mechanics ensure your vehicles are always in top condition.
              </p>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Ready to Experience Caldot Care?
            </h2>
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join thousands of satisfied customers who trust Caldot Care for their vehicle maintenance needs.
            </p>
...
export default AutomobileMaintenancePage
