...
const LogisticsPage = () => {
  ...
  const stats = [
    { number: '500+', label: 'Fleet Vehicles', icon: Truck },
    ...
    <main className="min-h-screen">
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Comprehensive logistics and transportation services with modern fleet management, 
              real-time tracking, and efficient route optimization.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our logistics services provide end-to-end transportation solutions for businesses of all sizes. 
                We operate a modern fleet with advanced tracking technology, ensuring your goods are delivered 
                safely and on time. Our experienced team handles everything from local deliveries to cross-country transportation.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/contact?service=logistics" className="btn-primary group">
                  Get Started
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-zodiac-blue mb-6">
              Why Choose Our Logistics Service
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We've built our reputation on reliability, efficiency, and customer satisfaction.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Contact us today to discuss your logistics needs and discover 
              how we can help streamline your transportation operations.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact?service=logistics" className="btn-secondary group">
                Get a Quote
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-300" />
              </Link>
